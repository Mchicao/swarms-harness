...
### 2. DeepSWE Benchmark (GLM Open-Weight Scaling)
...
> Inspired by the [LLM-as-a-Verifier self-verification study](https://github.com/llm-as-a-verifier/llm-as-a-verifier#self-verification-terminal-bench-21).
